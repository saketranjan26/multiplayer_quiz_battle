...
export const Question=({questionNumber,question}:props)=>{
    ...
    return (
        <div className="bg-slate-200 mx-3 my-3 rounded-md">
            <label className="block my-1 mx-3 text-md font-bold text-gray-900">{"Question "+questionNumber}</label>
            <div className="mx-3">
                {question.question}
            </div>
            ...
            <button onClick={()=>{
                ...
                {Check===`${correctOption} is correct` && <div className="bg-green-600 text-green-200 rounded-md px-2 py-2">
                        Correct!
                </div>}
                {Check===`${correctOption} is wrong` && <div className="bg-red-600 text-red-200 rounded-md px-2 py-2">
